...
import { Expense, RegularOffering, Donor, EnvelopeOffering, ServiceType, Fellowship } from '../types';
...
export const api = {
  fellowships: {
      getAll: async (): Promise<Fellowship[]> => {
          return [
              { id: '1', name: 'Paradiso' },
              { id: '2', name: 'Jerusalemu B' },
              { id: '3', name: 'Paradiso C' },
              { id: '4', name: 'Kaanani' },
              { id: '5', name: 'Sayuni' },
              { id: '6', name: 'Betania' },
              { id: '7', name: 'Galilaya' },
